/**
 * Middleware de autenticacion JWT para el Servicio Statistics.
 *
 * Valida el JWT emitido por el Servicio Auth (mismo contrato que Library,
 * Sprint 2):
 *
 ...
 *
 * No monta rutas. GET /summary permanece publico y no se ve afectado por este
 * archivo. No registra el token en logs. No expone detalles internos de
...
export const validateJWT = (req, res, next) => {
  ...
  if (!secret) {
    console.error('Statistics Service | validateJWT: JWT_SECRET no esta configurado');
